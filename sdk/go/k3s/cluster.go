...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("k3s:index:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ClusterOutput) Agents() NodeArrayOutput {
	return o.ApplyT(func(v *Cluster) NodeArrayOutput { return v.Agents }).(NodeArrayOutput)
}
...
func (o ClusterOutput) MasterNodes() NodeArrayOutput {
	return o.ApplyT(func(v *Cluster) NodeArrayOutput { return v.MasterNodes }).(NodeArrayOutput)
}

func (o ClusterOutput) VersionConfig() VersionConfigurationPtrOutput {
	return o.ApplyT(func(v *Cluster) VersionConfigurationPtrOutput { return v.VersionConfig }).(VersionConfigurationPtrOutput)
}
